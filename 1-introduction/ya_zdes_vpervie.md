...
Другими словами, Голос чем-то похож на смесь обычной социальной сети на подобие Фейсбука и более комплексной платформы для блогеров, на подобие Живого Журнала.
...
Допустим у Вас и еще у 100 человек есть свой колхоз (в котором Вы все явлеетесь владельцами). Прежде чем Вы, что то выращиваете, Вы это обсуждаете и принимаете 100% обоюдное решение о том что выращивать, почем продавать, где продавать и тд. Это децентрализация.
...
Стоит заметить что общая сумма вознаграждения всегда равна 10% от добытых "блоков" и в независимости от того, кто за кого голосует, будет распределена между теми кто в этот день писал / курировал контент.
...
В Голосе криптовалютой является «токен» (монета) которая называется... Голос (не ожидали, так ведь?). Именно её цена определяет размер ежедневного "банка наград" (помните про 10%, которые выделяет сеть на выплаты за контент?) по отношению к привычной Вам валюте (чуть ниже подробнее).  
...
Так же выплата явлеется потенциальной по двум причинам:
...
Заходим на сайт www.golos.io , регистрируемся (ЗАПИСЫВАЕМ свой 32-значный пароль!), и начинаем пользоваться! Начинать можно уже сейчас, хотя первые выплаты по наградам (в связи с проведением ИКО) будут не ранее середины января 2017г, и далее каждый день (по мере написания Вами контента и, само собой, по мере его популярности!).
...
Вы всегда можете найти нас в рокет чате - https://chat.golos.io (пишите пользователю - @serejandmyself)
