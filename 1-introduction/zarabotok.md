...
<p><strong>3) HDD майнинг </strong>- это использование дискового пространства для обработки данных. Некоторые криптовалюты устроены по такому принципу, что для поддержания их работоспособности требуется не вычислительная мощность, а дисковое пространство. Примеры таких криптовалют - Burst, Storj. Это интересная альтернатива GPU майнингу, так как не требуется мощного железа, нужно больше терабайтов. Например, при предоставлении 60TB - доход составит 12$ в день (или порядка 600 руб./день).</p>
...
<p>Плюсы:</p>
<ul>
  <li>пассивный заработок, один раз настроил и работает (есть конечно свои нюансы при масштабировании)</li>
</ul>
<p>Минусы:</p>
<ul>
  <li>много шума при работе видеокарт</li>
