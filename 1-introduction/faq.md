...
За свой контент автор получает выплату два раза: первый (основной) раз после 24 часов. И второй раз (если, конечно, после первой выплаты контент будет "лайкнут" другими кураторами) по истечении 30 дней.
