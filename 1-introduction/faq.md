...
Нет. На всех пользователей Стим будет распределено 10% от всех выпущенных СГ. При этом примерно 6% достанется техническому аккаунту @steemit. Таким образом, пользователи Стима в Голосе будут держателями менее 4%.
