...
Регистрационный взнос устанавливается в голосах делегатами таким образом, чтобы он стремился к 30 миллиграмам золота (ориентировочно 1.5 доллара или 100 российских рублей). На ранней стадии регистрационный взнос оплачивается cyber•Fund при регистрации на домене https://golos.io. По мере развития сети могут быть разработаны стимулы для регистрации сторонними операторами. До момента внедрения подобных стумулов в случае, если cyber•Fund откажет в предоставлении услуги по оплате регистрации, сообщество вправе скоординироваться, чтобы привлечь необходимый ресурс на открытых рынках. 9% резерв кибер•Фонда на финансирование регистраций изначально недостаточен для регистрации всех 260 млн. людей.

## Мотивация Регистраторов
В оригинальной разработке Стим сторонние регистраторы не имеют мотивации для регистрации пользователей. В будущих релизах Голоса будет предусмотрена мотивация регистраторам нести риски связанные с затратами на регистрацию пользователей в обмен на возможность получать какую-то часть дохода с заработка зарегистрированных пользователей.
...
Вся дистрибьюция осуществляется в силе ГОЛОСА (GP), за исключением следующих аккаунтов бирж включенных в шеардроп: poloniex, openledger, blocktrades, bittrex.

Обоснование предложенного механизма дистрибьюции:
...
В целях обеспечения прозрачности и доказуемости краудсейла будет использован следующий генезис-адрес: **35ZoE4Evycq9rBqp4GfnpegaLA9RKScrb2**. Этот адрес не предполагается использовать для непосредственного перечисления денег во время краудсейла. Вместо этого он будет использоваться для перенаправления биткоинов, перечисляемых на уникальный адрес, который будет генериться для каждого участника краудсейла. Этот адрес будет публично записываться в блокчейн Голоса как метаданные пользователя. Генезис-адрес является мультиподписной учетной записью 4 из 6, который контролируется 5 из 8 основателей + 1 независимый подписан. Таким образом, средства, собираемые во время краудсейла, будут доказуемо собраны и прозрачно потрачены.
...
## Cофтверная лицензия
10% шеардроп сообществу Стим является платежом за софтверную лицензию на блокчейн Стима. Это поощрение также направлено на мотивирование существующих разработчиков приложений на поддержку локализованного блокчейна. В дополнение данное решение может способствовать формированию стартовой ликвидности базового токена - ГОЛОСА, которая критична для успешного становления системы выплаты вознаграждений. Копия состояния текущих пользователей платформы Стима осуществлена в 12:00 UTC 29 Сентября 2016 года. В снимок вошло 8380 аккаунтов. 4 512 000 ГОЛОСов направляется на аккаунт *cyberdrop* и распределяется между аккаунтами в по следующей формуле:
...
Аккаунтам бирж в исключительном порядке начисляются ГОЛОСа (GOLOS), а не Сила ГОЛОСа (GP) в целях мотивации обеспечения стартовой ликвидности.
...
По истечению 47 дней станет доступна функция усиления ГОЛОСА. С этого момента 90% эмитируемых ГОЛОСОВ будет распределятся владельцам Силы ГОЛОСА. Дистрибьюция

- Награды за курирование: 1 ГОЛОС в блок или 3.875% в год, смотря что больше
- Награды за создание контента: 1 ГОЛОС в блок или 3.875% в год, смотря что больше
