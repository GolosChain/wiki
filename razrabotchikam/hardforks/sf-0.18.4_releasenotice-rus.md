# SF-0.18.4: Новые возможности СофтФорка

## GOLOS·CORE

## Очередная версия SoftFork 0.18.4

_**Golos·Core объявляет о выпуске очередной версии SoftFork 0.18.4, в которой реализованы новые функциональные возможности, а также устранены недостатки предыдущих версий. Обновления поддержаны большинством голосов делегатов.**_

**Важное:**  
_**SF 0.18.4 требует выполнения переиндексации из всех предыдущих версий.**_
