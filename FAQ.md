...
## Так как Сила голоса будет начислятся пользователям Стимит пропорционально их балансам, то киты Стимита автоматически станут китами Голоса?
