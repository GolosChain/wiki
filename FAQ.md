...
Сеть будет развернута до запуска краудфандинговой кампании, то есть до 15 октября 2016 г. Возможность регистрироваться, постить и комментировать будет у пользователей с момента запуска сети. Возможность получать вознаграждение - после завершения краудфандинга и распределения токенов, то есть после 15 ноября 2016 г.
...
Нет. На всех пользователей Стим будет распределено 10% от всех выпущенных СГ. При этом примерно 6% достанется техническому аккаунту @steemit. Таким образом, киты Стима в Голосе будут держателями менее 4%.

## Если киты Стима начнут продавать начисленное вознаграждение, как это отразиться на Голосе?
...
Репутация не будет сохранена. Пользователи Стима, учетные записи которых будут скопированы, получат на свой аккаунт токены Силы Голоса.
...
В это время наш фокус будет на постах со следюущими тэгами:
- #познакомимся. По аналогии с #introducemyself
- #голосвгороде. Посвещен митапам в разных уголках мира посвященных проекту Голос.
- #голос. Посвящен разным исследованиям, разработкам и прочей полезной работе по проекту.
- Тэги #экономика #технологии #образование #новости также являются ключевым фокусом для курирования на старте.

Однако для устойчивого развития сети будет предложена программа баунти для разработчиков, занимающимся поиском и устранением уязвимостей клиента, блокчейна и инфраструктуры.
...
Выплаты пользователям будут осуществляться в токенах социальной сети: Голос (аналог Steem), Сила Голоса  (аналог Steem Power), Золотой, обеспеченный Голосом (аналог Steem Backed Dollar). Вознаграждение будет отражаться в кошельках пользователей в пересчете на удобную пользователям валюту.
...
## Планиуруются ли в Голосе уникальные, отличные от Стима функции?
Да.
