...
1. установка с использованием доступной платформы [Docker](hf18_instruction.md#bld_412);  
...
Инструкции по установке HF•18 в вариантах 1-3 изложены в разделах [2](hf18_instruction.md#bld_2), [3](hf18_instruction.md#bld_3) и [4](hf18_instruction.md#bld_4) соответственно.
...
* объем оперативной памяти:  
  * 16 ГБ для [делегатского Узла](hf18_instruction.md#bld_410) в варианте конфигурации LOWMEM;  
  * 64 ГБ для [API Узла](hf18_instruction.md#bld_411) в полной конфигурации;  
...
* отключить функцию подписания блоков отключением [плагина](hf18_instruction.md#bld_48) witness;  
...
1. сконфигурировать [Docker-образ](hf18_instruction.md#bld_413) в отдельном пространстве;  
2. создать [контейнер](hf18_instruction.md#bld_46) с использованием Docker-образа. Контейнер можно размещать как на локальном компьютере, так и на удаленном или виртуальном;  
3. [воспроизвести блокчейн](hf18_instruction.md#bld_43).
...
| :--- | :--- |
| witness | Устанавливает имя [аккаунта](hf18_instruction.md#bld_41) делегата \(для делегатского Узла\) |
...
В этом разделе приведена инструкция по построению Docker-образа с использованием различных [Docker-файлов](hf18_instruction.md#bld_414).
...
**3.** Построить проект с установкой [демона](hf18_instruction.md#bld_45) в `/usr/local/`, исполнив:
