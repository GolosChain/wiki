...
* [Новые функциональные возможности в HF•18](hf18_api_changes.md#перечень-новых-функциональных-возможностей-в-hf18)
* [Новые технические возможности в HF•18](hf18_api_changes.md#перечень-новых-технических-возможностей-в-hf18)
* [Измененные и новые плагины API в HF•18](hf18_api_changes.md#измененные-и-новые-плагины-в-hf18):
  * [private\_message](hf18_api_changes.md#изменения-в-плагине-privatemessage)
  * [witness\_api](hf18_api_changes.md#новый-плагин-witnessapi)
  * [account\_history](hf18_api_changes.md#изменения-в-плагине-accounthistory)
  * [operation\_history](hf18_api_changes.md#новый-плагин-operationhistory)
  * [social\_network](hf18_api_changes.md#изменения-в-плагине-socialnetwork)
  * [tags](hf18_api_changes.md#новый-плагин-tags)
  * [follow](hf18_api_changes.md#изменения-в-плагине-follow)
  * [database\_api](hf18_api_changes.md#изменения-в-плагине-databaseapi)
...
* [get\_proposed\_transaction](hf18_api_changes.md#новый-метод-getproposedtransaction)
* [get\_database\_info](hf18_api_changes.md#новый-метод-getdatabaseinfo)
* [get\_vesting\_delegations](hf18_api_changes.md#новый-метод-getvestingdelegations)
* [get\_expiring\_vesting\_delegations](hf18_api_changes.md#новый-метод-getexpiringvestingdelegations)  

Новые операции:

* [изменение или возврат делегирования Силы Голоса](hf18_api_changes.md#новая-операция-изменение-или-возврат-делегирования-силы-голоса)
* [создание аккаунта с делегированием Силы Голоса](hf18_api_changes.md#новая-операция-создание-аккаунта-с-делегированием-силы-голоса)
* [изменение json\_metadata  аккаунта](hf18_api_changes.md#новая-операция-изменение-jsonmetadata--аккаунта)
* [предложение на транзакцию](hf18_api_changes.md#новая-операция-предложение-на-транзакцию)
* [обновление предложенной транзакции](hf18_api_changes.md#новая-операция-обновление-предложенной-транзакции)
* [удаление предложенной транзакции](hf18_api_changes.md#новая-операция-удаление-предложенной-транзакции)
* [изменение параметров блокчейна](hf18_api_changes.md#новая-операция-изменение-параметров-блокчейна)
...
* `maximum_block_size` — максимальный размер блока блокчейна;  
* `sbd_interest_rate` — процент, начисляемый на SBD;  
* `create_account_min_golos_fee` — минимальный размер комиссионных отчислений в криптовалюте Голос, требуемых на создание аккаунта с делегированием \(по умолчанию принимает значение "1.000 GOLOS", см. операцию [account\_create\_with\_delegation](hf18_api_changes.md#новая-операция-создание-аккаунта-с-делегированием-силы-голоса)\);  
* `create_account_min_delegation` — устанавливает минимально возможное количество Силы Голоса при создании аккаунта с делегированием \(по умолчанию принимает значение "5.000 GOLOS", см. операцию [account\_create\_with\_delegation](hf18_api_changes.md#новая-операция-создание-аккаунта-с-делегированием-силы-голоса)\);  
...
* `min_delegation` — устанавливает минимально возможное количество Силы Голоса для делегирования на аккаунт \(по умолчанию принимает значение "10.000 GOLOS", см. операцию [delegate\_vesting\_shares](hf18_api_changes.md#новая-операция-изменение-или-возврат-делегирования-силы-голоса)\).  
