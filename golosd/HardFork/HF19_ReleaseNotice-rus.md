...
После создания поста автор может указать процент кураторских отчислений от ожидаемого вознаграждения за этот пост.  По умолчанию процент кураторских отчислений составляет 50 %.  

В версии HF-19.0 делегатам также предоставлена возможность ограничивать процент кураторских отчислений в пределах от 25 до 100 %. По умолчанию процент кураторских отчислений может выбираться авторами в пределах от 50 до 100 %.  
